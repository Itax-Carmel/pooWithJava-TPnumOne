...
class TPnumOne {
  ...
  static void noteDesCours(Scanner scanner) {
    ...
    // Affectation de value aux Arrays resultInterro et coefDuCour ayant des length
    // la valeur de numDesCours
    ...
    for (int i = 0; i < coefDuCour.length; i++) {
      // Utilisation de la boucle do...while pour vérifier l'entré du user et
      // s'assurer qu'il entre une valeur comprise entre 1 et 6 pour la pondération de
      // cours
      do {
    ...
    for (int i = 0; i < resultInterro.length; i++) {
      // Utilisation de la boucle do...while pour vérifier l'entré du user et
      // s'assurer qu'il entre une valeur comprise entre 0 et 20 pour les résultats
      // des interros
      do {
